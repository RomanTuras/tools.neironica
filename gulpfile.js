...
gulp.task('img-responsive', async function() {
	return gulp.src('resources/img/_src/**/*.{png,jpg,jpeg,webp,raw}')
		.pipe(newer('resources/img/@1x'))
		.pipe(responsive({
			'*': [{
				// Produce @2x images
...
gulp.task('cleanimg', function() {
	return del(['resources/img/@*'], { force: true })
});
...
gulp.task('watch', function() {
	...
	gulp.watch(['libs/**/*.js', 'resources/js/helpers/*.js', 'resources/js/txt-tools/*.js'], gulp.parallel('scripts'));
	gulp.watch('resources/views/*.blade.php', gulp.parallel('code'));
